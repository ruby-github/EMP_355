...
public:
    ...
    vector<string> GetSelFolder() {
        return m_vecFolder;
    }
    vector<string> GetSelPath() {
        return m_vecPath;
    }
private:
    ViewCD();
    ...
    // signal connect
    static void HandleBtnAddClicked(GtkButton *button, ViewCD *data) {
        data->BtnAddClicked(button);
    }
    static void HandleBtnAddAllClicked(GtkButton *button, ViewCD *data) {
        data->BtnAddAllClicked(button);
    }
    static void HandleBtnDelClicked(GtkButton *button, ViewCD *data) {
        data->BtnDelClicked(button);
    }
    static void HandleBtnDelAllClicked(GtkButton *button, ViewCD *data) {
        data->BtnDelAllClicked(button);
    }
    static void HandleBtnBackupClicked(GtkButton *button, ViewCD *data) {
        data->BtnBackupClicked(button);
    }
    static void HandleBtnExportClicked(GtkButton *button, ViewCD *data) {
        data->BtnExportClicked(button);
    }
    static void HandleBtnEraseClicked(GtkButton *button, ViewCD *data) {
        data->BtnEraseClicked(button);
    }
    static void HandleBtnExitClicked(GtkButton *button, ViewCD *data) {
        data->BtnExitClicked(button);
    }
    static gboolean on_window_delete_event(GtkWidget *widget, GdkEvent *event, ViewCD *data) {
