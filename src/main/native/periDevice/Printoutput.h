...
private:
    ...
    static void on_button_nupstylechange(GtkWidget *button, gpointer dat, Printoutput *data) {
        data->ButtonNupStyleChange(dat);
    }
    static void on_button_resetbutton(GtkWidget *button, gpointer dat, Printoutput *data) {
        data->ButtonResetButton(dat);
    }
