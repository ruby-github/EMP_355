...
public:
    ...
    void SetBalanceStatus(bool balance) {
        m_balance = balance;
    }
    ...
    bool GetHPRFStatus();
    bool GetSimut3Status(void) {
        return m_simult3;
    }
    bool GetSimut2Status(void) {
        return m_simult2;
    }
...
private:
    ...
    void SwitchHPRF(bool on, float svPos);
...
public:
    ...
    int GetBandPassFilterList() {
        return m_bandPassFilterList;
    }
};
