...
private:
    ...
    static void HandleMeasureSequenceChanged(GtkComboBox *widget, MeasureSetting *data) {
        data->MeasureSequenceChanged(widget);
    }

    static void HandleExamCalcChanged(GtkComboBox *widget, MeasureSetting *data) {
