...
private:
    ...
    static void HandleSendReportToggled(GtkToggleButton *togglebutton, DicomServiceSetting *data) {
        data->ChkBtnSendReportToggled(togglebutton);
    }
    static void HandleSendVideoToggled(GtkToggleButton *togglebutton, DicomServiceSetting *data) {
    ...
    static void HandleAutoQueryToggled(GtkToggleButton *togglebutton, DicomServiceSetting *data) {
    ...
    static void HandleMPPSToggled(GtkToggleButton *togglebutton, DicomServiceSetting *data) {
    ...
    static void HandleStorageCommitmentToggled(GtkToggleButton *togglebutton, DicomServiceSetting *data) {
