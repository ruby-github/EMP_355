...
bool CArrow::Delete() {
  ...
  m_updateArrow.DrawArrow(arrowElem.pos, arrowElem.direction,
    ARROW_SCALE[arrowElem.size], arrowElem.color, arrowElem.shape);
...
bool CArrow::DeleteAll() {
  ...
  while(m_arrowList.size()) {
    ...
    m_updateArrow.DrawArrow(arrowElem.pos, arrowElem.direction,
      arrowElem.size, arrowElem.color, arrowElem.shape);
    m_arrowList.pop_back();
  }
