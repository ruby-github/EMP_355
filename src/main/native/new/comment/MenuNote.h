...
private:
    ...
    static void HandleComboDeptChanged(GtkComboBox *widget, MenuNote *data) {
        data->BtnComboDeptChanged(widget);
    }
    ...
    static gboolean HandleTreeBtnPress(GtkWidget *widget, GdkEventButton *event, MenuNote *data) {
        data->TreeBtnPress(widget, event);
        return FALSE;
    }
};
