...
GtkWidget* CalcSetting::CreateCalcWindow(GtkWidget* parent) {
  ...
  gtk_table_attach(table, GTK_WIDGET(m_combobox_department), 0, 3, 2, 3, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
  ...
  gtk_table_attach(table, GTK_WIDGET(button_add), 3, 4, 7, 8, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
  gtk_table_attach(table, GTK_WIDGET(button_delete), 3, 4, 8, 9, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
  ...
  gtk_table_attach(table, GTK_WIDGET(button_export), 7, 8, 6, 7, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
  gtk_table_attach(table, GTK_WIDGET(button_import), 7, 8, 7, 8, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
...
string CalcSetting::GetExamName() {
  return Utils::combobox_active_text(m_combobox_exam_type);
}

string CalcSetting::GetDepartmentName() {
  return Utils::combobox_active_text(m_combobox_department);
}
...
void CalcSetting::ButtonClickedSelectAll(GtkButton* button) {
  ...
  string department = Utils::combobox_active_text(m_combobox_department);
  ...
  for(int i=0; i<size; i++) {
    if(strcmp(department.c_str(), _(SECTIONS[i].c_str()))==0) {
...
void CalcSetting::DeleteItem() {
  ...
  string department_name = Utils::combobox_active_text(m_combobox_department);

  char department[50];
  size_t size = sizeof(SECTIONS) / sizeof(SECTIONS[0]);

  for(int i=0; i<size; i++) {
    if(strcmp(department_name.c_str(), _(SECTIONS[i].c_str()))==0) {
...
void CustomCalc::CreateCalcSettingWin(GtkWidget* parent) {
  ...
  gtk_table_attach(table, GTK_WIDGET(m_entry_name), 1, 3, 0, 1, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
  ...
  gtk_table_attach(table, GTK_WIDGET(m_combobox_type), 1, 3, 1, 2, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
  ...
  gtk_table_attach(table, GTK_WIDGET(m_combobox_method), 1, 3, 2, 3, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
...
void CustomCalc::CreateExportCalcSettingWin(GtkWidget* parent) {
  ...
  gtk_table_attach(table, GTK_WIDGET(m_entry_export_name), 2, 6, 1, 2, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
  ...
  gtk_table_attach(table, GTK_WIDGET(m_progress_bar), 0, 6, 4, 5, (GtkAttachOptions)(GTK_FILL | GTK_EXPAND), GTK_SHRINK, 0, 0);
...
void CustomCalc::ButtonClickedOK(GtkButton* button) {
  ...
  string method_name = Utils::combobox_active_text(m_combobox_method);
  ...
  for(int i=0; i<size; i++) {
    if(strcmp(method_name.c_str(), CUSTOM_TYPES[i].name.c_str()) == 0) {
...
void CustomCalc::ComboboxChangedType(GtkComboBox* combobox) {
  ...
  Utils::combobox_clear(m_combobox_method);
