...
class ExamItem
{
	public:
		...
		enum EItem {ABDO_ADULT, ABDO_LIVER, ABDO_KID, CAR_ADULT, CAR_KID, GLANDS, THYROID, EYE, SMALL_PART, GYN, EARLY_PREG, LATER_PREG,CAR_FETUS, 
			KIDNEY, BLADDER, CAROTID, JUGULAR, PERI_ARTERY, PERI_VEIN, HIP_JOINT, MENISCUS, JOINT_CAVITY, SPINE, TCD, USER1, USER2, USER3, USER4,USERNAME,USER};///< order must be indetical to ITEM_LIB[]
#endif	
	struct ParaCommon
		{
...
#else
		static const int NUM_ITEM = 28; ///< total number of item
#endif
