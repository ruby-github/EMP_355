...
private:
    ...
    static void HandleChkInvert(GtkButton *button, MenuCFM *data) {
        data->ChkInvertClicked(button);
    }
    static void HandleChkColorHide(GtkButton *button, MenuCFM *data) {
        data->ChkColorHideClicked(button);
    }
    static void HandleChkBgHide(GtkButton *button, MenuCFM *data) {
        data->ChkBgHideClicked(button);
    }
    static void HandleChkBC(GtkButton *button, MenuCFM *data) {
        data->ChkBCClicked(button);
    }
    static void HandleBtn4BCFM(GtkButton *button, MenuCFM *data) {
        data->Chk4BCFM(button);
    }
    static void HandleChkPdiDir(GtkButton *button, MenuCFM *data) {
        data->ChkPdiDirClicked(button);
    }
    static void HandleChkCompare(GtkButton *button, MenuCFM *data) {
        data->ChkCompareClicked(button);
    }
    static void HandleComboScaleChanged(GtkComboBox *widget, MenuCFM *data) {
        data->BtnComboScaleChanged(widget);
    }
    static void HandleForeachWidget(gpointer element, MenuCFM *data) {
