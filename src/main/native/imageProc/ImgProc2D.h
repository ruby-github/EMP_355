...
public:
    ...
    SIZE GetEFOVROISize(void) {
        return m_roiEFOVSize;
    }
    bool GetUpDownStatusForIMT(void) {
        return m_UD;   //get updown mark for IMT measure
    }
    int GetGrayTranIndex(void) {
        return m_CurCurveIndex;
    }
