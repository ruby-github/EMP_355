...
private:
    ...
    static void on_dicom_radio_button_toggled(GtkToggleButton *togglebutton, CustomType *data) {
        data->DicomRadioToggled(togglebutton);
    }
    static void on_emp_radio_button_toggled(GtkToggleButton *togglebutton, CustomType *data) {
        data->EmpRadioToggled(togglebutton);
    }
    static void HandleBtnOkClicked(GtkButton *button, CustomType *data) {
        data->BtnOkClicked(button);
    }
    static void HandleBtnCancelClicked(GtkButton *button, CustomType *data) {
        data->BtnCancelClicked(button);
    }
    static gboolean on_window_delete_event(GtkWidget *widget, GdkEvent *event, CustomType *data) {
...
public:
    ...
    vector<string> GetItemFlash() {
        return vec;
    }
    vector<string> GetSelSid() {
        return m_vecFlashSid;
    }
    vector<string> GetSelName() {
        return m_vecFlashName;
    }
//hlx
#ifdef VET
    enum {
...
private:
    ...
    void BtnSendClicked(GtkButton *button);
    ...
    // signal connect
    static void HandleEventBoxCalendarStartPress(GtkWidget *widget, GdkEventButton *event, ViewArchive *data) {
        data->EventBoxCalendarStartPress(widget, event);
    }
    static void HandleEventBoxCalendarEndPress(GtkWidget *widget, GdkEventButton *event, ViewArchive *data) {
        data->EventBoxCalendarEndPress(widget, event);
    }
    static void HandleBtnUdiskClicked(GtkButton *button, ViewArchive *data) {
        data->BtnUdiskClicked(button);
    }
    static void HandleBtnClearClicked(GtkButton *button, ViewArchive *data) {
        data->BtnClearClicked(button);
    }
    static void HandleBtnSearchClicked(GtkButton *button, ViewArchive *data) {
        data->BtnSearchClicked(button);
    }
    static void HandleBtnDisplayClicked(GtkButton *button, ViewArchive *data) {
        data->BtnDisplayClicked(button);
    }
    static void HandleBtnDeleteClicked(GtkButton *button, ViewArchive *data) {
        data->BtnDeleteClicked(button);
    }
    static void HandleBtnSelectAllClicked(GtkButton *button, ViewArchive *data) {
        data->BtnSelectAllClicked(button);
    }
    static void HandleBtnUnselectAllClicked(GtkButton *button, ViewArchive *data) {
        data->BtnUnselectAllClicked(button);
    }
    static void HandleBtnSendClicked(GtkButton *button, ViewArchive *data) {
        data->BtnSendClicked(button);
    }
    static int HandleBtnExportEvent(GtkWidget *widget, GdkEvent *event, ViewArchive *data) {
        return data->BtnExportEvent(widget, event);
    }
    static int HandleBtnUdiskEvent(GtkWidget *widget, GdkEvent *event, ViewArchive *data) {
        return data->BtnImportEvent(widget, event);
    }
    static void HandleBtnExitClicked(GtkButton *button, ViewArchive *data) {
        data->BtnExitClicked(button);
    }
    static void HandleToggleRecord(GtkCellRendererToggle *cell, gchar *path_str, ViewArchive *data) {
        data->ToggleRecord(cell, path_str);
    }
    static void HandleTreeSelectionChanged(GtkTreeSelection *selection, ViewArchive *data) {
        data->TreeSelectionChanged(selection);
    }
    static void HandleBtnPreviewClicked(GtkButton *button, ViewArchive *data) {
        data->BtnPreviewClicked(button);
    }
    ...
    static void HandleBtnToggleKb(GtkToggleButton *toggleButton, ViewArchive *data) {
        data->FillDiskSpace();
    }
    static void HandleBtnToggleMb(GtkToggleButton *toggleButton, ViewArchive *data) {
        data->FillDiskSpace();
    }
    static void HandleBtnToggleGb(GtkToggleButton *toggleButton, ViewArchive *data) {
        data->FillDiskSpace();
    }
#ifndef VET
    static void HandleBtnQueryRetrieveClicked(GtkButton *button, ViewArchive *data) {
        data->BtnQueryRetrieveClicked(button);
    }
#endif
    static void PROGRESSSTATUS(int nPos);
};
