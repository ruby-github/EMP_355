...
#endif
    static gboolean on_window_delete_event(GtkWidget *widget, GdkEvent *event, ViewDicomDataSelect* data) {
        return data->WindowDeleteEvent(widget, event);
    }
    static void HandleTreeSelectionChanged(GtkTreeSelection *selection, ViewDicomDataSelect *data) {
