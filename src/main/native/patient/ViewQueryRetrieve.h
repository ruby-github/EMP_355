...
public:
    ...
    void GetInfo(PatientInfo::Info &info) {
        info =m_info;
    }
...
private:
    ...
    static void HandleStartCalendarPress(GtkWidget *widget, GdkEventButton *event, ViewQueryRetrieve *data) {
        data->StartCalendarPress(widget, event);
    }

    static void HandleEndCalendarPress(GtkWidget *widget, GdkEventButton *event, ViewQueryRetrieve *data) {
        data->EndCalendarPress(widget, event);
    }

    static void HandleToggleRecord(GtkCellRendererToggle *cell, gchar *path_str, ViewQueryRetrieve *data) {
        data->ToggleRecord(cell, path_str);
    }
    static void HandleSelectAllToggled(GtkToggleButton *togglebutton, ViewQueryRetrieve *data) {
        data->ChkSelectAllToggled(togglebutton);
    }
    static unsigned int  GetDCMStudyElement(DCMSTUDYELEMENT element);
    static string  GetDCMImageElement(DCMIMAGEELEMENT element,unsigned char *pImageBuf, unsigned long bufLen);
    static void  GetDCMSRElement(DCMSRELEMENT element);
