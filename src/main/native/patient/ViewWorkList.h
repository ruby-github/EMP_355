...
private:
    ...
    static void HandleStartCalendarPress(GtkWidget *widget, GdkEventButton *event, ViewWorkList *data) {
        data->StartCalendarPress(widget, event);
    }

    static void HandleEndCalendarPress(GtkWidget *widget, GdkEventButton *event, ViewWorkList *data) {
