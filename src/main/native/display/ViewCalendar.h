...
private:
    ...
    // signal connect
    static void HandleDestroyEvent(GtkWidget *widget, ViewCalendar *data) {
        data->DestroyEvent(widget);
    }
    static void HandleCalendarDaySelectedDoubleClick(GtkCalendar *calendar, ViewCalendar *data) {
        data->CalendarDaySelectedDoubleClick(calendar);
    }
};
