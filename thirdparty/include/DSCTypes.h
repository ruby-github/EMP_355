...
typedef struct tagIP2DAttributes
{
	...
	unsigned char ipaLineAver;		//!< value: 64,48,32,24
...
typedef struct tagDSCControlAttributes
{
	...
	unsigned char dcaReserved3;			//!< not define
	unsigned char dcaReserved4;			//!< not define
